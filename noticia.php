...
<head>
    ...
    <title>Ribeiro Advocacia - Escritório de Advocacia em Pires do Rio - Goiás | Notícias</title>
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <section id="content" class="escritorio">
        <div class="container">
            <div class="posts">
                <div class="noticia-index-snippet noticia-full">
                    ...
                    <div class="noticia-info">
                        ...
                        <div class="noticia-leiamais"><a href="autor.php?id=<?php echo $postagem->get_autor(); ?>"><?php echo $postagem->get_nomeautor(); ?></a></div>
                        <div class="clear"></div>
                    </div> 
                    <div class="noticia-conteudo">
                        <p>                  
                            <?php echo $postagem->get_conteudo(); ?>
                        </p>

                        <div class="fb-like" data-href="https://www.ribeirosadvocacia.adv.br/noticia.php?id<?php echo $posts['id']?>" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div>
                    </div>
                </div> 
