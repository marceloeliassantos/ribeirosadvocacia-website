<?php
    ...
    $noticias = $noticia->fetch_custom("categoria", $_GET['id']);
    $qtd = $noticia->get_qtd();
...
<head>
    ...
    <title>Ribeiro Advocacia - Escritório de Advocacia em Pires do Rio - Goiás | Categorias</title>
...
<body>
    ...
    <section id="slider" class="page">
        <div class="container">
            <h1>Postagens em <?php echo $categoria->get_nome(); ?></h1>
        </div>
    </section>
